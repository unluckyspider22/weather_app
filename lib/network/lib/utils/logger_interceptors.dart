...
void logDebug(String message, {Level level = Level.info}) {
  ...
  if (kDebugMode) {
    try {
      ...
      switch (level) {
        case Level.debug:
          logMessage = '$cyanColor[DEBUG][$timeString] $message$cyanColor';
          break;
        case Level.info:
          logMessage = '$greenColor[INFO][$timeString] $message$greenColor';
          break;
        case Level.warning:
          logMessage = '$yellowColor[WARNING][$timeString] $message$yellowColor';
          break;
        case Level.error:
          logMessage = '$redColor[ERROR][$timeString] $message $redColor';
          break;
        case Level.alien:
